...
test:
	gotestsum --format pkgname --packages ./... -- -race -timeout 50m -cover -covermode atomic

test-ci:
	gotestsum --format pkgname --packages ./... --junitfile tests.xml -- -race -timeout 50m -coverprofile=coverage.txt -covermode atomic
