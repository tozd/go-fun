...
func TestOllamaJSON(t *testing.T) {
	...
	assert.Equal(t, `{"type":"ollama","model":"llama3:8b","maxContextLength":43,"maxResponseLength":56,"maxExchanges":57,"forceOutputJsonSchema":false,"seed":42,"temperature":0.7}`, string(out)) //nolint:testifylint
}
